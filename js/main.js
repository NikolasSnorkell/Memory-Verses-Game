let mas=[
    ...
    {src: "Галатам 6:4", txt:"Но каждый пусть оценивает собственные дела, и тогда он сможет радоваться своим успехам, не сравнивая себя с другими.5 Ведь каждый понесёт свою ношу."},    
