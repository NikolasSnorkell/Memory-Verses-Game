let mas=[
    ...
    {src: "Псалом 118:6", txt:"Иегова за меня, не буду бояться. Что сделает мне человек?"},    
    {src: "Псалом 119:165", txt:"Велик мир у тех, кто любит твой закон, И они ни обо что не споткнутся."},    
